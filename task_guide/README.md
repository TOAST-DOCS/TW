...
유관 부서와의 기술 검토는 **NHN-Cloud-테크니컬라이팅-콘텐츠제작** 프로젝트에서 진행합니다. 검토 과정에서 고객 문의 사례, 리소스 ID, 내부 로그처럼 공개할 수 없는 자료를 주고받아야 하고, 유관 부서의 업무 채널도 그쪽이기 때문입니다.
