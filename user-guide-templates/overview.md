...
* 본 템플릿이 적용된 예는 Cloud Scheduler, Notification Hub 등의 사용자 가이드 페이지를 참고할 수 있습니다.
...
* {**주요 기능 1의 제목을 점 목록, 볼드체, 명사형 종결 형태로 기재합니다.**(예: **다양한 서비스 구성**)}
  * {주요 기능 1에 대한 간단한 설명을 완전한 문장으로 입력합니다.(예: 인프라, 개발, 테스트, 운영과 기술 지원, 사업화에 필요한 다양한 서비스를 제공합니다.)}
  * {주요 기능 1에 대한 간단한 설명을 완전한 문장으로 입력합니다.}
* {**주요 기능 2의 제목을 점 목록, 볼드체, 명사형 종결 형태로 기재합니다.**(예: **플랫폼 중심 클라우드**)}
  * {주요 기능 2에 대한 간단한 설명을 완전한 문장으로 입력합니다.(예: 인프라에 기반한 플랫폼 중심 클라우드입니다.)}
  * {주요 기능 2에 대한 간단한 설명을 완전한 문장으로 입력합니다.}
* {**주요 기능 3의 제목을 점 목록, 볼드체, 명사형 종결 형태로 기재합니다.**(예: **합리적인 가격**)}
  * {주요 기능 3에 대한 간단한 설명을 완전한 문장으로 입력합니다.(예: 사용한 만큼만 과금됩니다.)}
  * {주요 기능 3에 대한 간단한 설명을 완전한 문장으로 입력합니다.}
