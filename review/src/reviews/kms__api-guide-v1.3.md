...
## 변경해야 할 항목
- [x] [변경분] 30·33·225·228·237·240행 등 `유저` → `사용자` 일괄 변경 — 글로서리 부합, 적절
- [x] [변경분] 427행 `clientSentCerfificate` → `clientSentCertificate` 오타 수정, 적절
- [x] [변경분] 2086행 `certtificate2` → `certificate2` 오타 수정, 적절
- [x] [변경분] 1148·1189·1232행 JSON 예시 후행 콤마 제거 및 1231행 `lifeTime` 뒤 콤마 추가, 적절
- [x] [변경분] 1260·1386·1508행 응답 표 필드명 `value` → `name`(실제 응답 `name`과 일치), 적절
- [x] [변경분] 1513~1634행 키 저장소 생성/수정/삭제 신규 섹션 추가 — API 목록·본문·표 구조 일관, 적절
- [x] [변경분] 2143행 인증서 상세 조회 `expirationDate` 행 추가, 적절
